...
The files with "StickxNLE" use strings to represent stickers that encode the address of each strands.  This code was derived from the javascript DNA sticker simulator (http://xlnsresearch.com/sticker1.htm).
