...
static boolean s0,s1,s2,S3,s4,S5,s6,s7,s8,s9;
static boolean c0,c1,c2,c3,c4,c5,c6,c7,c8,c9;
static boolean z1,z2,z3,z4,z5,z6,z7,z8;
static boolean f1,f2,f3,f4,f5,f6,f7,f8,f9;
...
{int i,jj,iii,start;
 ...
 //for (start=249; start<=257;start++)
 {
  ...
  if ((start&0x3f)==59)   combine(Mts+2-1, Mt+2); //aw>=7?
   //also?? if ((start&0x3ff)==2038) combine(Mts+3-1, Mt+3); //aw>=12?
